	...
	var Player = React.createClass({ displayName: "Player",
		...
		getActions: function getActions() {
			return {
				...
				setHeight: __webpack_require__(13).bind(this),

				playPause: __webpack_require__(14).bind(this),
				seekTo: __webpack_require__(15).bind(this),
				updateBuffer: __webpack_require__(16).bind(this),

				dragControl: __webpack_require__(17).bind(this),
				onDraggerDrop: __webpack_require__(18).bind(this),
				hideControlTimeout: __webpack_require__(19).bind(this),
				hideControl: __webpack_require__(20).bind(this),
				showControl: __webpack_require__(21).bind(this),

				videoEvents: __webpack_require__(22).bind(this),

				toggleFullscreen: __webpack_require__(23).bind(this),
				fullscreenChange: __webpack_require__(24).bind(this)
	...
	var Control = React.createClass({ displayName: "Control",
		...
		render: function render() {
			...
			return React.createElement("div", { className: className,
				...
				dragDeplacement: props.dragDeplacement }), React.createElement(Time, null, props.duration), React.createElement(Fullscreen, { fullscreen: props.fullscreen,
				actions: props.actions }));
		},
