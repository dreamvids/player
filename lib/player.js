...
/***/ function(module, exports, __webpack_require__) {
	...
	var Player = React.createClass({ displayName: "Player",
			...
			render: function render() {
					...
					return React.createElement("div", { className: "player", style: style }, "source: ", state.source, React.createElement("br", null), React.createElement("br", null), "volume: ", state.volume, React.createElement("br", null), React.createElement("br", null), React.createElement(Control, { actions: this.getActions(),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimeLine = __webpack_require__(9);
	...
	var Control = React.createClass({ displayName: "Control",
					...
					render: function render() {
									...
									return React.createElement("div", { className: "player__control" }, React.createElement(PlayPause, { actions: props.actions,
													playing: props.playing }), React.createElement(Time, null, props.currentTime), React.createElement(TimeLine, { actions: props.actions }), React.createElement(Time, null, props.duration), React.createElement(Fullscreen, { actions: props.actions }));
					}
